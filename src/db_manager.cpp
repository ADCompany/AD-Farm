...
const QString CDBManager::component::customers = "CustomersData";
...
//	SetDBComponent(std::shared_ptr<IDBComponent>(new CStoragesData()), "StoragesData", true);
	SetDBComponent(std::shared_ptr<IDBComponent>(new CCustomersData(nullptr, std::shared_ptr<CDBManager>(this))), "CustomersData", true);
