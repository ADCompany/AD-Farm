...
protected slots:// Slots
	...
	void onAddTransaction()
	{
		...
		for (int i = 0; i < farmInfo.count(); ++i)
		{
			...
			m_pStoragesData->BuyStorageData(strStorageName, m_pStoragesData->GetLastGroupNameByStorage(strStorageName),
				lstProducts, lstPrCount, lstProductCost, QString::fromUtf8("\325\216\325\241\325\263\325\241\325\274\326\204"));
		}
